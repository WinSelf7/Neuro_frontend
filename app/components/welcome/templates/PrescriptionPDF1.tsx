...
// Styles with alternative design theme
const styles = StyleSheet.create({
  page: {
    padding: 30,
    fontFamily: "Helvetica",
    fontSize: 10,
    color: "#1a1a1a", // Dark gray text instead of pure black
  ...
  organizationName: {
    fontSize: 12,
    fontWeight: "bold",
    color: "#006666", // Teal color for organization name
    marginBottom: 4,
    letterSpacing: 0.4,
  },
  address: {
  ...
  sectionHeader: {
    backgroundColor: "#006666", // Teal instead of navy blue
    color: "#FFFFFF",
    padding: 7,
    fontSize: 10,
    fontWeight: "bold",
...
const PrescriptionPreview: React.FC<{ 
  ...
  return (
    ...
    >
      ...
      {/* Header */}
      <div className="flex justify-between items-start mb-7" style={{ borderBottom: "2px solid #006666", paddingBottom: "15px" }}>
        <div className="flex-1 max-w-[60%]">
          <div className="text-sm font-bold mb-0" style={{ color: "#006666" }}>ASSOCIATION CENTRE</div>
          <div className="text-sm font-bold mb-1" style={{ color: "#006666" }}>OPHTALMOLOGIE LA BOULE</div>
          <div className="text-xs mb-0.5" style={{ color: "#333333" }}>16 avenue Maréchal Joffre</div>
          <div className="text-xs mb-0.5" style={{ color: "#333333" }}>92000 NANTERRE</div>
          <div className="text-xs mb-0.5" style={{ color: "#333333" }}>Tél : 01 46 95 15 15</div>
          <div className="text-xs mb-0.5" style={{ color: "#333333" }}>Email : info-laboule@ophtalys.fr</div>
          <div className="text-xs mt-2 font-bold" style={{ color: "#006666" }}>FINESS : 920036563</div>
        </div>
        <div className="w-[130px] flex justify-end">
          {logoPath ? (
            ...
            <div className="text-white px-2 py-2 w-[110px] h-[55px] flex flex-col items-center justify-center" style={{ backgroundColor: "#006666", borderRadius: "4px" }}>
      ...
      {/* Date Section */}
      <div className="flex justify-end items-baseline mb-7" style={{ paddingBottom: "8px", borderBottom: "1px solid #e0e0e0" }}>
        <span className="text-xs mr-1 font-semibold">Fait à Nanterre le</span>
        <span className="text-xs mr-1 font-semibold">Date :</span>
        <span className="text-xs px-2 min-w-[140px] inline-block font-bold" style={{ color: "#006666", borderBottom: "1px solid #006666" }}>
          {formDate || "___ / ___ / ______"}
        </span>
      </div>
      ...
      {/* Patient Section */}
      <div className="mb-5">
        <div className="text-white px-2 py-2 text-xs font-bold mb-3 uppercase tracking-wide" style={{ backgroundColor: "#006666", borderRadius: "3px" }}>
          PATIENT
        </div>
        <div className="flex items-end mb-3 pb-0.5" style={{ borderBottom: "0.5px solid #f0f0f0" }}>
          <span className="text-xs font-bold w-[230px] pr-2.5" style={{ color: "#006666" }}>Nom :</span>
          <span className="text-xs flex-1 pb-1 min-h-[18px]">
            {data.patient?.last_name || ""}
          </span>
        </div>
        <div className="flex items-end mb-3 pb-0.5" style={{ borderBottom: "0.5px solid #f0f0f0" }}>
          <span className="text-xs font-bold w-[230px] pr-2.5" style={{ color: "#006666" }}>Prénom :</span>
          <span className="text-xs flex-1 pb-1 min-h-[18px]">
            {data.patient?.first_name || ""}
          </span>
        </div>
        <div className="flex items-end mb-3 pb-0.5" style={{ borderBottom: "0.5px solid #f0f0f0" }}>
          <span className="text-xs font-bold w-[230px] pr-2.5" style={{ color: "#006666" }}>N° Sécurité Sociale (NIR) :</span>
          <span className="text-xs flex-1 pb-1 min-h-[18px]">
            {data.patient?.nir || ""}
          </span>
        </div>
        <div className="flex items-end mb-3 pb-0.5" style={{ borderBottom: "0.5px solid #f0f0f0" }}>
          <span className="text-xs font-bold w-[230px] pr-2.5" style={{ color: "#006666" }}>Date de naissance :</span>
          <span className="text-xs flex-1 pb-1 min-h-[18px]">
            {birthDate || ""}
          </span>
        </div>
      ...
      <div className="mb-5">
        <div className="flex items-end mb-3 pb-0.5" style={{ borderBottom: "0.5px solid #f0f0f0" }}>
          <span className="text-xs font-bold w-[230px] pr-2.5" style={{ color: "#006666" }}>Je soussigné(e), Docteur :</span>
          <span className="text-xs flex-1 pb-1 min-h-[24px]">
            {data.doctor?.full_name || ""}
          </span>
        </div>
        <div className="flex items-end mb-3 pb-0.5" style={{ borderBottom: "0.5px solid #f0f0f0" }}>
          <span className="text-xs font-bold w-[230px] pr-2.5" style={{ color: "#006666" }}>RPPS :</span>
          <span className="text-xs flex-1 pb-1 min-h-[18px]">
            {data.doctor?.rpps || ""}
          </span>
        </div>
      ...
      {/* Orthoptic Care Section */}
      <div className="mb-5 p-2" style={{ backgroundColor: "#f8fafa", borderRadius: "3px" }}>
        <div className="flex items-end mb-3">
          <span className="text-xs font-bold w-[230px] pr-2.5" style={{ color: "#006666" }}>Les soins orthoptiques suivants :</span>
          <span className="text-xs flex-1 pb-0.5 min-h-[24px]">
            {data.orthoptic_care?.description || ""}
          </span>
        </div>
      </div>
      ...
      {/* Prescribed Acts Section */}
      <div className="mb-6 p-3" style={{ border: "1px solid #e0e0e0", borderRadius: "4px", backgroundColor: "#fafafa" }}>
        <div className="text-white px-2 py-2 text-xs font-bold mb-3 uppercase tracking-wide" style={{ backgroundColor: "#006666", borderRadius: "3px" }}>
          ACTES PRESCRITS :
        </div>
        <div className="text-xs min-h-[150px] pt-2">
          {data.orthoptic_care?.acts_prescribed_details && data.orthoptic_care.acts_prescribed_details.length > 0 ? (
            data.orthoptic_care.acts_prescribed_details.map((act, index) => (
              <div key={index} className="mb-2 pl-3 pt-0.5" style={{ borderLeft: "3px solid #006666", marginLeft: "4px" }}>
                - {act.code}
                {act.label ? ` : ${act.label}` : ''}
                {act.price ? ` - ${act.price.toFixed(2)} €` : ''}
              </div>
      ...
      {/* Footer */}
      <div className="flex justify-between mt-14 relative" style={{ paddingTop: "15px", borderTop: "2px solid #e0e0e0" }}>
        <div className="w-[48%]">
          <div className="text-[9px] font-bold mb-2 uppercase tracking-wide" style={{ color: "#006666" }}>Cachet du centre</div>
          <div className="min-h-[65px] pt-2 flex items-center justify-center p-2" style={{ border: "1px dashed #ccc", borderRadius: "3px", backgroundColor: "#fafafa" }}>
            {stampPath ? (
              <img
                src={stampPath}
                alt="Centre Stamp"
              ...
              <div className="text-[7px] text-center leading-tight" style={{ color: "#666666", opacity: 0.8 }}>
        ...
        <div className="w-[48%] flex flex-col items-end">
          <div className="text-[9px] font-bold mb-2 uppercase tracking-wide" style={{ color: "#006666" }}>Signature du prescripteur</div>
          <div className="w-full min-h-[65px] flex items-center justify-end p-2" style={{ border: "1px dashed #ccc", borderRadius: "3px", backgroundColor: "#fafafa" }}>
            {signaturePath ? (
              <img
                src={signaturePath}
              ...
              <div className="w-full min-h-[65px]"></div>
            )}
          </div>
        </div>
      ...
      {showDownloadButton && (
        <div className="sticky bottom-4 right-4 float-right z-10 mt-4">
          <button
            ...
            style={{ fontFamily: "inherit", backgroundColor: "#006666" }}
