...
// Styles matching the template exactly
    ...
    >
      ...
      <div className="flex justify-between items-start mb-6">
        <div className="flex-1 max-w-[60%]">
          <div className="text-sm font-bold mb-0">ASSOCIATION CENTRE</div>
          <div className="text-sm font-bold mb-1">OPHTALMOLOGIE LA BOULE</div>
          <div className="text-xs mb-0.5">16 avenue Maréchal Joffre</div>
          <div className="text-xs mb-0.5">92000 NANTERRE</div>
          <div className="text-xs mb-0.5">Tél : 01 46 95 15 15</div>
          <div className="text-xs mb-0.5">Email : info-laboule@ophtalys.fr</div>
          <div className="text-xs mt-1.5">FINESS : 920036563</div>
        </div>
        <div className="w-[130px] flex justify-end">
          {logoPath ? (
            ...
            <div className="bg-[#000080] text-white px-2 py-2 w-[110px] h-[55px] flex flex-col items-center justify-center">
      ...
      <div className="flex justify-end items-baseline mb-6">
        <span className="text-xs mr-1">Fait à Nanterre le</span>
        <span className="text-xs mr-1">Date :</span>
        <span className="text-xs px-2 min-w-[140px] inline-block">
          {formDate || "___ / ___ / ______"}
        </span>
      </div>
      ...
      {/* Patient Section */}
      <div className="mb-4">
        <div className="bg-[#000080] text-white px-2 py-1.5 text-xs font-bold mb-3 uppercase tracking-wide">
          PATIENT
        </div>
        <div className="flex items-end mb-3">
          <span className="text-xs font-bold w-[220px] pr-2">Nom :</span>
          <span className="text-xs flex-1 pb-0.5 min-h-[18px]">
            {data.patient?.last_name || ""}
          </span>
        </div>
        <div className="flex items-end mb-3">
          <span className="text-xs font-bold w-[220px] pr-2">Prénom :</span>
          <span className="text-xs flex-1 pb-0.5 min-h-[18px]">
            {data.patient?.first_name || ""}
          </span>
        </div>
        <div className="flex items-end mb-3">
          <span className="text-xs font-bold w-[220px] pr-2">N° Sécurité Sociale (NIR) :</span>
          <span className="text-xs flex-1 pb-0.5 min-h-[18px]">
            {data.patient?.nir || ""}
          </span>
        </div>
        <div className="flex items-end mb-3">
          <span className="text-xs font-bold w-[220px] pr-2">Date de naissance :</span>
          <span className="text-xs flex-1 pb-0.5 min-h-[18px]">
            {birthDate || ""}
          </span>
        </div>
      ...
      <div className="mb-4">
        <div className="flex items-end mb-3">
          <span className="text-xs font-bold w-[220px] pr-2">Je soussigné(e), Docteur :</span>
          <span className="text-xs flex-1 pb-0.5 min-h-[22px]">
            {data.doctor?.full_name || ""}
          </span>
        </div>
        <div className="flex items-end mb-3">
          <span className="text-xs font-bold w-[220px] pr-2">RPPS :</span>
          <span className="text-xs flex-1 pb-0.5 min-h-[18px]">
            {data.doctor?.rpps || ""}
          </span>
        </div>
      ...
      <div className="mb-4">
        <div className="flex items-end mb-3">
          <span className="text-xs font-bold w-[220px] pr-2">Les soins orthoptiques suivants :</span>
          <span className="text-xs flex-1 pb-0.5 min-h-[22px]">
            {data.orthoptic_care?.description || ""}
          </span>
        </div>
      ...
      <div className="flex justify-between mt-12 relative">
        <div className="w-[48%]">
          <div className="text-[9px] font-bold mb-2">Cachet du centre</div>
          <div className="min-h-[60px] pt-1 flex items-center justify-center">
            {stampPath ? (
              <img
                src={stampPath}
                alt="Centre Stamp"
              ...
              <div className="text-[7px] text-[#000000] opacity-60 text-center leading-tight">
        ...
        <div className="w-[48%] flex flex-col items-end">
          <div className="text-[9px] font-bold mb-2">Signature du prescripteur</div>
          <div className="w-full min-h-[60px] flex items-center justify-end">
            {signaturePath ? (
              <img
                src={signaturePath}
      ...
      {showDownloadButton && (
        <div className="sticky bottom-4 right-4 float-right z-10 mt-4">
          <button
            ...
            className="bg-[#000080] hover:bg-[#0000a0] text-white px-4 py-2 rounded-lg shadow-lg transition-colors flex items-center gap-2"
